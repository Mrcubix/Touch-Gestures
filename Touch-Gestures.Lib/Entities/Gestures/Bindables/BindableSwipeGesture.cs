...
namespace TouchGestures.Lib.Entities.Gestures
{
    ...
    public class BindableSwipeGesture : SwipeGesture, IBindable
    {
        ...
        public BindableSwipeGesture(Vector2 threshold, double deadline, ISharedBinding binding) : this(threshold, deadline)
        {
            Binding = binding;
        }

        public BindableSwipeGesture(Vector2 threshold, double deadline, SwipeDirection direction, ISharedBinding binding) : this(threshold, deadline, direction)
        {
            Binding = binding;
        }
        ...
        public static BindableSwipeGesture? FromSerializable<T>(SerializableSwipeGesture? swipeGesture, Dictionary<int, TypeInfo> identifierToPlugin, SharedTabletReference? tablet)
